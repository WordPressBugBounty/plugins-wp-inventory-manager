...
/**
 * Loop All In Category - Table Layout
 * version 1.2.2
 */
...
if ( wpinventory_have_items() ) {
    ...
    ?>
    <table class="wpinventory_loop wpinventory_loop_category wpinventory_loop_category-<?php echo wpinventory_get_the_category_ID(); ?>">
        <thead>
        <tr>
			<?php if ( wpinventory_get_config( 'display_listing_labels' ) ) {
				...
				do_action( 'wpim_template_loop_category_table_headings_end', 'table' );
			} ?>
        </tr>
        </thead>
        <tbody>
